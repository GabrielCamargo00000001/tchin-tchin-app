...
const SPRINT14_ITEMS = [
  ...
  { id: 'B2', kind: 'alteracao', title: 'Botão Comprar na tela de detalhe do vinho', owner: 'Guilherme', module: 'M04', status: 'aprovado', urgent: true,
  ...
  { id: 'A2', kind: 'alteracao', title: 'Sub aba Estoque da confraria mantem-se (decisao revista)', owner: 'Gustavo', module: 'M11', status: 'aprovado', urgent: false,
  ...
  { id: 'F3', kind: 'alteracao', title: 'Manter Estoque na sub aba da confraria (decisao revista)', owner: 'Gustavo', module: 'M11', status: 'aprovado', urgent: false,
  ...
  { id: 'F4', kind: 'feature', title: 'Onboarding com 3 slides MKT', owner: 'Bruno', module: 'M02', status: 'aprovado', urgent: false,
  ...
  { id: 'F5', kind: 'feature', title: 'Templates para criação de eventos', owner: 'alocar', module: 'M12', status: 'aprovado', urgent: false,
  ...
  { id: 'F6', kind: 'feature', title: 'Correlação confraria template', owner: 'alocar', module: 'M12', status: 'aprovado', urgent: false,
  ...
  { id: 'F7', kind: 'feature', title: 'Modal tutorial pós criação de confraria', owner: 'alocar', module: 'M11', status: 'aprovado', urgent: false,
  ...
  { id: 'F8', kind: 'push', title: 'Push D+3 sem evento criado', owner: 'alocar', module: 'M11 e M18', status: 'aprovado', urgent: false,
  ...
  { id: 'F9', kind: 'feature', title: 'Onboarding novo membro em confraria', owner: 'alocar', module: 'M11', status: 'aprovado', urgent: false,
  ...
  { id: 'F11', kind: 'feature', title: 'Cutuca o organizador', owner: 'Otavio', module: 'M11 e M18', status: 'aprovado', urgent: false,
  ...
  { id: 'F12', kind: 'push', title: 'Push de evento D-3 D-1 dia', owner: 'Otavio', module: 'M12 e M18', status: 'aprovado', urgent: false,
  ...
  { id: 'F13', kind: 'feature', title: 'API Meta SDK Instagram, Facebook e tracking', owner: 'Otavio', module: 'M01 + M14 + M18', status: 'aprovado', urgent: true,
  ...
  { id: 'P1', kind: 'push', title: 'Push 4h após cadastro sem registrar', owner: 'Otavio', module: 'M18', status: 'aprovado', urgent: false,
  ...
  { id: 'P2', kind: 'push', title: 'Push 3º dia 9h sobre quiz paladar', owner: 'Otavio', module: 'M18', status: 'aprovado', urgent: false,
  ...
  { id: 'P3', kind: 'push', title: 'Push 7º dia 18h sentiu sua falta', owner: 'Otavio', module: 'M18', status: 'aprovado', urgent: false,
