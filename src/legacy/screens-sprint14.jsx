...
const SPRINT14_ITEMS = [
  ...
  { id: 'A1', kind: 'feature', title: 'Tela Descobri', owner: 'Guilherme', module: 'M04', status: 'definir', urgent: false,
    ...
    telas: ['home/descobrir (transformado em Descobri)', 'wine', 'confraria-detalhe', 'event-detalhe', 'confraria-detalhe aba Experiência', 'scanner', 'marketplace', 'quiz (calibração)'],
  },
  { id: 'A2', kind: 'alteracao', title: 'Label Adega não Estoque', owner: 'Gustavo', module: 'M07', status: 'definido', urgent: false,
    ...
    telas: ['Bottom nav global', 'home/adega', 'perfil-eu seção Atividade', 'ProfileDrawer', 'Push 4h (P1)', 'favoritos', 'lista-desejos', 'register-consumo passo 2'],
  },
